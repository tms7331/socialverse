        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 md:pr-8 mb-8 md:mb-0">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              IRL Social Club brings people together by making it easy to find
              and join real-life experiences with others who share your
              interests. By importing data from your favorite apps, IRL Social
              Club matches you with curated events—like intimate dinners, scenic
              walks, or lively music nights—designed to connect you with
              like-minded people. Or, explore community-hosted events in your
              area, from pickleball games to cozy watch parties. Whether you're
              looking to meet new friends or simply find something fun to do,
              IRL Social Club makes discovering meaningful in-person experiences
              effortless.
            </p>
