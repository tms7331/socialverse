...
export const FAVICONS_SOURCE = 'public/logo-light.svg'; // Source image(s). `string`, `buffer` or array of `string`
...
export const FAVICONS_SHELL_DIR = 'components/head/favicons/';
