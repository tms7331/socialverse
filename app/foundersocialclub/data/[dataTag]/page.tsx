...
export default function DataManagementClient() {
    ...
    const getItemFromDynamo = async () => {
        ...
        const response = await fetch("/api/getItem", {
            ...
            body: JSON.stringify({ "tableName": tableName, "key": { "did": did, "dataTag": dataTag } }),
        });
    ...
    const addItemToDynamo = async () => {
        ...
        const response = await fetch("/api/addItem", {
            ...
            body: JSON.stringify({ "tableName": tableName, "content": { "did": did, "dataTag": dataTag, "data": "fake data 123" } }),
        });
        const result = await response.json();
