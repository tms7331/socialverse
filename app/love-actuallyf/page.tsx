import { ChevronLeft, ChevronRight, Minus, Plus, Settings, Heart } from "lucide-react"
        ...
        <div className="flex flex-col h-screen bg-gray-100">
            <header className="bg-white shadow-md p-4">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <Link href="/matches" className="text-gray-600 hover:text-gray-800 transition-colors">
                        ...
                        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
                            <div className="relative aspect-[3/4] w-full">
                                ...
                                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black to-transparent p-4">
                                    <h2 className="text-white text-xl font-semibold">John Doe, 28</h2>
                            ...
                            <div className="p-6 bg-white">
                                <p className="text-gray-700 text-sm">
                                    Software Developer | Dog Lover | Hiking Enthusiast

                                    I'm a passionate coder by day and an adventurous spirit by night. When I'm not crafting elegant solutions to complex problems, you can find me exploring hiking trails with my loyal four-legged companion, Max. I believe in the perfect balance of technology and nature, and I'm always up for a good challenge, whether it's debugging a tricky piece of code or conquering a new mountain peak.

                                    My ideal match is someone who shares my love for the outdoors and can appreciate a good tech joke. Bonus points if you can keep up with me on a trail and don't mind my occasional dad jokes. Let's grab a coffee (or better yet, hit a trail) and see if we click!

                                    Interests: Coding, Hiking, Photography, Craft Beer, Sci-Fi Movies
                                </p>
                            </div>
                        </div>
                    </div>
