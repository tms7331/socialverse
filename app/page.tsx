...
const pages: Page[] = [
  ...
  { id: 'love-actually', title: 'Love, Actually', icon: <MessageSquareHeart className="h-8 w-8" />, categories: ['dating'], href: '/love-actually' },
  { id: 'sociairl', title: 'SociaIRL', icon: <Heart className="h-8 w-8" />, categories: ['dating', 'realWorld'], href: '/sociairl' },
  { id: 'cofounder-match', title: 'Cofounder Match', icon: <Users className="h-8 w-8" />, categories: ['realWorld', ' networking'], href: '/cofounder-match' },
  { id: 'love-actuallyf', title: 'Love, ActuallyF', icon: <MessageSquareHeart className="h-8 w-8" />, categories: ['dating'], href: '/love-actuallyf' },
  { id: 'sociairlf', title: 'SociaIRLF', icon: <Heart className="h-8 w-8" />, categories: ['dating', 'realWorld'], href: '/sociairlf' },
]
