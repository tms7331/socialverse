        ...
        {!isYCVerified ? (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Sign up and verify your YC status
              </CardDescription>
            </CardHeader>
              ...
              <Dialog>
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Please provide your YC credentials to verify your
                      membership.
                    </DialogDescription>
                  </DialogHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your YC membership has been verified.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Link href="/foundersocial/account" passHref>
                <Button className="w-full">Go to Manage Account</Button>
              </Link>
            </CardContent>
          </Card>
        )}
