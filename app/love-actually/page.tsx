      ...
      <main className="container mx-auto px-4 py-12">
        <section className="max-w-2xl mx-auto text-center mb-12 bg-white/40 backdrop-blur-sm rounded-lg p-8">
          <h2 className="text-4xl font-bold mb-6 text-gray-800">
            Welcome to Love, Actually
          </h2>
          <p className="text-lg text-black mb-8">
            Discover "Love, Actually" – the dating app that makes intentional
            dating easy!
          </p>
          <p className="text-lg text-black mb-8">
            By letting you import data from popular apps, it matches you with
            people who truly share your interests and values.
          </p>
          <p className="text-lg text-black mb-8">
            With similarity scores across key interests and an improved version
            of OKCupid's compatability score, you’ll meet partners who feel like
            a perfect fit.
          </p>
          <p className="text-lg text-black mb-8">
            Robust filtering options let you only match with those who meet your
            criteria. Whether you're looking for a fun date or a serious
            relationship, "Love, Actually" makes it easy to be intentional in
            your journey to find the right match.
          </p>
        </section>
